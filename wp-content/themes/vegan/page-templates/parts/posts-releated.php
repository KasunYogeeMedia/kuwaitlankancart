<?php
    $relate_count = vegan_get_config('number_blog_releated', 3);
    $relate_columns = vegan_get_config('releated_blog_columns', 3);
...
?>
    <div class="widget">
        <h4 class="widget-title">
            <span><?php esc_html_e( 'Releated Posts', 'vegan' ); ?></span>
        </h4>
