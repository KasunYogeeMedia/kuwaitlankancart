...
if ( $attachment_ids ) {
    ...
    ?>
    <div class="owl-carousel thumbnails-image-carousel" data-items="<?php echo esc_attr($columns); ?>" data-carousel="owl" data-smallmedium="2" data-extrasmall="2" data-pagination="false" data-nav="true">
