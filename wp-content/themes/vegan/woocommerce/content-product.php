...
$woo_display = vegan_woocommerce_get_display_mode();
if ( $woo_display == 'list' ) { 	
?>
...
<?php 
	...
	$classes[] = 'col-lg-'.$columns.' col-md-'.$columns.' col-sm-6 col-xs-6 grid product '.( $woocommerce_loop['loop'] % 2 == 0 ? ' xs-clearfix' : '');
	?>
