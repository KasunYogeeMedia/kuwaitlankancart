...
class Vegan_Widget_Popup_Promotion extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_popup_promotion',
            esc_html__('Apus Popup Promotion Widget', 'apus-themer'),
            array( 'description' => esc_html__( 'Show Popup Promotion', 'apus-themer' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <!-- social -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'url' )); ?>"><strong><?php esc_html_e('Url:', 'apus-themer');?></strong></label>
...
register_widget( 'Vegan_Widget_Popup_Promotion' );