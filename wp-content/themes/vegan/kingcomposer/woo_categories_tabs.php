                ...
                <li<?php echo ($i == 0 ? ' class="active"' : ''); ?>>
                    <a href="#tab-<?php echo esc_attr($_id);?>-<?php echo esc_attr($i); ?>" data-toggle="tab">
                    	<?php if ( isset($tab->image) && $tab->image ): ?>
                            ...
                            <?php $img_hover = wp_get_attachment_image_src($tab->icon_image_hover, 'full'); ?>
    						<?php if (isset($img[0]) && $img[0]) { ?> 
    					    	<img src="<?php echo esc_url_raw($img[0]);?>" alt="" />
    						<?php } ?>
                            <?php if (isset($img_hover[0])) { ?>
                                <img src="<?php echo esc_url_raw($img_hover[0]);?>" alt="" class="image-icon-hover">
                            <?php } ?>
    					<?php elseif (isset($tab->icon) && $tab->icon): ?>
